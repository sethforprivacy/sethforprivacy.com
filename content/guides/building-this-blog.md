...
eventually settled on ["Terminal"](https://github.com/panr/hugo-theme-terminal) by [@panr](https://x.com/panr). Not only was the theme very 
...
Thanks for reading, and please don't hesitate to reach out via [Signal, SimpleX, X, or Nostr]({{< ref "/content/about.md#how-to-contact-me" >}}) if you have any questions or would like more detail!
